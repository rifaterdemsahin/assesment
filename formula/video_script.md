...
*   **Act III:** [act3.jpg](https://github.com/rifaterdemsahin/assesment/blob/main/imaginary/act3.jpg?raw=true)
...
1.  **Use Relative Paths:** Change the paths to be relative to this file.
    ...
    *   *Fix:* `../imaginary/act1.png` (this file is in `formula/` and images are in the sibling `imaginary/` folder).
